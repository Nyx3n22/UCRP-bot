...
-- CreateIndex
CREATE UNIQUE INDEX "DormitoryRoom_roomNumber_key" ON "DormitoryRoom"("roomNumber");
...
-- AddForeignKey
ALTER TABLE "DormitoryResident" ADD CONSTRAINT "DormitoryResident_roomId_fkey" FOREIGN KEY ("roomId") REFERENCES "DormitoryRoom"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
